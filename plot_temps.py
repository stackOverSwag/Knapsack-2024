...
df = pd.read_csv(csv_file_path, header=None, names=['Taille', 'BT1', 'BT2', 'DP', 'DP_Value'])
...
plt.semilogy(df['Taille'], df['DP_Value'], label='Programmation Dynamique (Value)', marker='n')
